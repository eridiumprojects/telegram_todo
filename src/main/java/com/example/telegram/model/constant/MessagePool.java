...
public class MessagePool {
    ...
    public static final String LOGIN_IN_ACCOUNT_WITH_MESSAGE = "Войти с помощью команды ";
    ...
    public static final String IN_ACCOUNT_FIRST_MESSAGE = "Приступим к планированию!\n" +
            "\nСоздать новый таск с помощью команды ";
    public static final String IN_ACCOUNT_SECOND_MESSAGE = "\nПосмотреть список всех тасков с помощью команды ";
    public static final String IN_ACCOUNT_THIRD_MESSAGE = "\nВыйти из аккаунта с помощью ";
    public static final String NEXT_ACTS_MESSAGE = "Для дальнейших действий используйте команду ";
