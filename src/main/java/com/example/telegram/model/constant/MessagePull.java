...
public class MessagePull {
    ...
    public static final String LOGIN_IN_ACCOUNT_WITH_MESSAGE = "Войдите в аккаунт с помощью команды ";
    ...
    public static final String RETURN_MESSAGE = "Для выхода в главное меню используйте команду ";
